...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le pide al usuario el nombre de un atleta y luego le muestra el pais representa
	 */
	private void ejecutarPaisRepresentante()
	{
		System.out.println("\n"+"El pais que representa el Atleta"+"\n");
		String nombreatleta = input("Por favor ingrese el nombre de un atleta");
		String nombrePais = calculadora.BuscarPaisDelAtleta(nombreatleta);
		System.out.println("El atleta representa a "+ nombrePais);
	}
